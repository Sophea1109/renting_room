            ...
            <div className="bg-gray-50 dark:bg-gray-900 rounded-[2rem] p-6 border-2 border-dashed border-gray-200 dark:border-gray-700 relative overflow-hidden">
              ...
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-xs text-gray-400">#{Math.random().toString(36).substr(2, 9).toUpperCase()}</p>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-gray-900 dark:text-white">{type === 'hotel' ? 'Hotel Booking' : 'Room Rental'}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">Item</span>
